...
export default function SobreMim(props) {
    ...
    <section class="sobre_mim"> 
        ...
        <p class="texto_sobre_mim">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque velit velit, volutpat semper dignissim     dictum, imperdiet ut lacus. Quisque gravida ex a mattis pretium. Suspendisse potenti. Ut semper sagittis ligula et lacinia. 
        <br /><br />
